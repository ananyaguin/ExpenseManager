...
import in.ananyaguin.expensemanager1.dto.IncomeDTO;
...
import in.ananyaguin.expensemanager1.repository.CategoryRepository;
import in.ananyaguin.expensemanager1.repository.IncomeRepository;
...
public class IncomeService {
    ...
    public List<IncomeDTO> getLatest5IncomesForCurrentUser() {
        ...
        List<IncomeEntity> list =
                incomeRepository.findTop5ByProfileIdOrderByDateDesc(profile.getId());
    ...
    public BigDecimal getTotalIncomeForCurrentUser() {
        ...
        BigDecimal total =
                incomeRepository.findTotalIncomeByProfileId(profile.getId());
