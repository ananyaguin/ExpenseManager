...
import in.ananyaguin.expensemanager1.dto.ExpenseDTO;
        ...
        for (ProfileEntity profile : profiles) {
            ...
            String body =
                    "Hi " + profile.getFullName() + ",<br><br>"
                            ...
                            + "<a href='" + frontendUrl + "' style='display:inline-block;padding:10px 20px;background-color:#4CAF50;color:#fff;text-decoration:none;border-radius:5px;font-weight:bold;'>Go to Expense Manager</a>"
                            + "<br><br>Best regards,<br>Expense Manager Team";
            ...
            if (!todaysExpenses.isEmpty()) {
                ...
                String body =
                        "Hi " + profile.getFullName()
                                ...
                                + table
                                + "<br/><br/>"
                                + "Best regards,<br/>Expense Manager Team";
